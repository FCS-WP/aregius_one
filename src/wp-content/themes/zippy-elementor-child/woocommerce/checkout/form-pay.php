...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th style="font-weight: bold" class="product-name"><?php esc_html_e( 'Product', 'woocommerce' ); ?></th>
				<th style="font-weight: bold" class="product-quantity"><?php esc_html_e( 'Qty', 'woocommerce' ); ?></th>
				<th style="font-weight: bold" class="product-total"><?php esc_html_e( 'Totals', 'woocommerce' ); ?></th>
			</tr>
		</thead>
		<tbody>
			...
			<?php if ( $totals ) : ?>
				<?php 
                    foreach ( $totals as $total ) : 
                        ...
                        ($order_type == 'workshop' && $total['label'] == 'Total:') ? $total['label'] = 'Deposit:' : '';
                ?>
					<tr>
